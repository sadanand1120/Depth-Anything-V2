...
class DepthRequest(BaseModel):
    ...
    camera_intrinsics: Optional[CameraIntrinsics] = Field(None, description="Camera intrinsics")
    ...
    max_depth: Optional[float] = Field(None, description="Max depth for scaling")
